...
/**
 * <p>Java class for BaseWireType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BaseWireType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;choice maxOccurs="unbounded" minOccurs="0"&gt;
 *         &lt;element name="connection" type="{http://www.mentor.com/harness/Schema/bridgesharness}BaseWireConnectionType"/&gt;
 *         &lt;element name="centerstripsplice" type="{http://www.mentor.com/harness/Schema/bridgesharness}BaseCenterstripspliceType"/&gt;
...
@XmlType(name = "BaseWireType", propOrder = {
    "connectionOrCenterstripspliceOrHarnesslevel"
})
@XmlSeeAlso({
    WireType.class
})
public class BaseWireType {

    @XmlElements({
        @XmlElement(name = "connection", type = BaseWireConnectionType.class),
        @XmlElement(name = "centerstripsplice", type = BaseCenterstripspliceType.class),
    ...
    protected List<Object> connectionOrCenterstripspliceOrHarnesslevel;
    ...
    /**
     * Gets the value of the connectionOrCenterstripspliceOrHarnesslevel property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the connectionOrCenterstripspliceOrHarnesslevel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getConnectionOrCenterstripspliceOrHarnesslevel().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BaseWireConnectionType }
     * {@link BaseCenterstripspliceType }
     ...
     * 
     */
    public List<Object> getConnectionOrCenterstripspliceOrHarnesslevel() {
        if (connectionOrCenterstripspliceOrHarnesslevel == null) {
            connectionOrCenterstripspliceOrHarnesslevel = new ArrayList<Object>();
        }
        return this.connectionOrCenterstripspliceOrHarnesslevel;
    }
